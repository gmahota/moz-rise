  ...
  return (
    <Card sx={{ border: 0, boxShadow: 0, color: 'common.white', backgroundColor: '#007BB6' }}>
      <CardContent sx={{ p: theme => `${theme.spacing(3.25, 5, 4.5)} !important` }}>
        ...
        "Investing in social services has been deeply fulfilling. Knowing that my resources are directly contributing to improving lives and communities is incredibly gratifying. The measurable impact on education, healthcare, and other essential services is a testament to the power of strategic philanthropy."
        </Typography>
