  ...
  return (
    <Card sx={{ border: 0, boxShadow: 0, color: 'common.white', backgroundColor: '#1D9BF0' }}>
      <CardContent sx={{ p: theme => `${theme.spacing(3.25, 5, 4.5)} !important` }}>
        ...
        "I had the pleasure of using Rise-Moz and I must say it exceeded my expectations. The level of quality and attention to detail was outstanding. I highly recommend it to anyone looking for shop to invest. I will definitely be a returning customer!"
        </Typography>
